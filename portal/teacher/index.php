...
<header class="app-header bg-primary" style="background-color: #af1e51 !important;" href="javascript:void(0);">ELIMU PORTAL</a>
...
$stmt = $conn->prepare
("SELECT * FROM tbl_announcements WHERE level = '0' OR level = '2' ORDER BY id DESC");
$stmt->execute();
