...
<head>
<title>ELIMU PORTAL - Dashboard</title>
<meta charset="utf-8">
...
<header  class="app-header bg-primary" style="background-color: #1e40af !important;" href="javascript:void(0);">ELIMU PORTAL</a>
...
<div class="col-md-6 col-lg-3">
<div class="widget-small secondary coloured-icon"><i class="icon feather icon-users fs-1"></i>
<div class="info">
<h4>Students</h4>
<p><b><?php echo number_format($students); ?></b></p>
</div>
</div>
</div>
<div class="col-md-6 col-lg-3">
